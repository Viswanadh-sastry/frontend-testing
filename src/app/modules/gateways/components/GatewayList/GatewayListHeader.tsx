...
const GatewayListHeader = ({ filterGateway }: IGatewayListHeaderProps) => {
  ...
  //   const blob = new Blob([workbookBinary], { type: "application/octet-gateway" });
