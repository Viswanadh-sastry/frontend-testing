...
import { getGatewayById, updateGateway } from "../../api/GatewayAPI";
...
const EditGateway = () => {
  ...
  const formik = useFormik({
    ...
    initialValues: {
      ...
      statsInterval: gateway?.statsInterval || 0,
      location: gateway?.location || null,
      metadata: gateway?.metadata || null,
      tags: gateway?.tags || null,
    } as Gateway,
    ...
    onSubmit: async (values, { setSubmitting }) => {
      ...
      updateGateway(String(values.gatewayId), data)
        .then(() => {
                    ...
                    <div className="fv-row mb-6">
                      ...
                      <LoadScript googleMapsApiKey="">
                        <GoogleMap
                          ...
                          center={{
                            lat: formik.values.location?.latitude || 0,
                            lng: formik.values.location?.longitude || 0,
                          }}
                          zoom={11}
                        >
                          <Marker
