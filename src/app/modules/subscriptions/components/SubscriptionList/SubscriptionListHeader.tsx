...
interface ISubscriptionListHeaderProps {
  ...
  setSubscriptionList: Dispatch<SetStateAction<any[]>>;
          ...
          <div className="d-flex align-items-center position-relative my-1">
            <input
              ...
              onChange={(e) => {
                ...
                setSubscriptionList(
                  subscriptionListQuery.data?.subscriptions.filter((subscription: any) => {
                    return subscription.name.toLowerCase().includes(e.target.value.toLowerCase());
                  })
                );
              }}
            />
