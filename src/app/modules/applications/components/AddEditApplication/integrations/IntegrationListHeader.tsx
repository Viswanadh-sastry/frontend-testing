...
interface IIntegrationListHeaderProps {
  filterIntegration: any;
}

const IntegrationListHeader = ({ filterIntegration }: IIntegrationListHeaderProps) => {
  const navigate = useNavigate();
  const params = useParams();
  const id = params.id as string;
  console.log("filterIntegration", filterIntegration);
  ...
  //   const { result: integrationList } = await getIntegration({
  //     status: filterIntegration.status,
  //   });
  ...
  //   const csvString = convertToCSV(integrationList, headerOrder);
  //   const blob = new Blob([csvString], { type: "text/csv" });
  //   const url = URL.createObjectURL(blob);
  //   const a = document.createElement("a");
  //   a.href = url;
  //   a.download = "Integration-List.csv";
  ...
  //   const formattedData = integrationList.map((item: any) => {
  ...
  //   const blob = new Blob([workbookBinary], { type: "integration/octet-integration" });
  //   // Create a download link for the blob
  //   const url = URL.createObjectURL(blob);
  //   const a = document.createElement("a");
  //   a.href = url;
  //   a.download = "Integration-List.xlsx";
  ...
  //       }[key])
  //   );
  //   const data = integrationList.map((item: any) =>
  //     headerOrder.map((key) => {
  //       return item[key] || "";
  //     })
  //   );
  //   // Set the title and calculate its width
  //   const title = "Integration List";
  ...
  //     },
  //   });
  //   doc.save("Integration-List.pdf");
  // };

  const onClickAddIntegration = () => {
    navigate(`/applications/${id}/integrations/add`);
  };
    ...
    <>
      <div className="card-header border-0 pt-6">
        ...
        <div className="card-toolbar">
          <div className="d-flex justify-content-end" data-kt-integration-table-toolbar="base">
            <button type="button" className="btn btn-primary me-2 mx-2" onClick={onClickAddIntegration}>
