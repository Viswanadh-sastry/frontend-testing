...
const DeviceListPagination = ({ filterDevice, setFilterDevice }: IDeviceListPaginationProps) => {
  const [pagination, setPagination] = useState<PaginationState>({
    page: 1,
    items_per_page: filterDevice.limit,
    links: [],
  });
  ...
  useEffect(() => {
    if (deviceListQuery.data) {
      const noOfLinks = deviceListQuery.data.totalCount;
      const noOfPages = Math.ceil(noOfLinks / filterDevice.limit);
      const links = [];
  ...
  return (
    <div className="row">
      <div className="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start">
        ...
        <div id="kt_table_devices_info" className="dataTables_info">
          {isLoading ? "Loading..." : `Total ${deviceListQuery.data?.totalCount || 0} devices`}
        </div>
      </div>
      <div className="col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end">
        <div id="kt_table_devices_paginate">
