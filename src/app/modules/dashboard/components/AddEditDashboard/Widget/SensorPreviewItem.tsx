  ...
  return (
    <>
      <div
        ...
        style={{
          position: "absolute",
          left: `${layout.widgetPosition.left}px`,
          top: `${layout.widgetPosition.top}px`,
          width: `${layout.widgetSize.width}px`,
          height: `${layout.widgetSize.height}px`,
        }}
      >
