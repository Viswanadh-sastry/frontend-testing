...
import { createGroupUser, getAddUsersListAll } from "../../../api/GroupUserAPI";
...
const AddUser = ({ onCloseAddUser, onGetUserList }: IAddUserProps) => {
  ...
  const userListQuery = useQuery({
    ...
    queryFn: async () => getAddUsersListAll(domainId, filterUser).catch((error) => toast.error(error?.response?.data?.message || "Something went wrong")),
    enabled: true,
  });
