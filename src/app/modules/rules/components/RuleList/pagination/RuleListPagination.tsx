...
interface IRuleListPaginationProps {
  ruleList: any[];
  itemsPerPage: any;
...
const RuleListPagination = ({ ruleList, itemsPerPage, pagination, data, setCurrentPage, setItemsPerPage, setPagination, setData }: IRuleListPaginationProps) => {
  useEffect(() => {
    getLinks();
  }, [data]);

  const getLinks = () => {
    const noOfLinks = ruleList.length;
  ...
  const updateState = (state: any) => {
    ...
    const historyData = ruleList.filter((_: any, index: number) => {
  ...
  return (
    <div className="row">
      <div className="col-sm-12 col-md-4 d-flex align-items-center justify-content-center justify-content-md-start">
        ...
        <div id="kt_table_rules_info" className="dataTables_info">
          Total {ruleList.length || 0} rules
        </div>
      </div>
      <div className="col-sm-12 col-md-8 d-flex align-items-center justify-content-center justify-content-md-end">
        <div id="kt_table_rules_paginate">
